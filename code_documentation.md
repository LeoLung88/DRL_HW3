# HW3-3 程式碼說明文件
## DQN Gridworld — 三階段漸進式實作（TensorFlow / tf.keras）

> **檔案清單**
> | 程式檔案 | Streamlit App | 環境 |
> |----------|---------------|------|
> | `stage1_dqn.py` | `streamlit_app.py` | Static Mode |
> | `stage2_dqn.py` | `streamlit_app2.py` | Player Mode |
> | `stage3_dqn.py` | `streamlit_app3.py` | Random Mode |
...
# Stage 3: Random Mode
streamlit run streamlit_app3.py --server.port 8503

# 命令列獨立訓練
python stage1_dqn.py   # 輸出 dqn_static_weights.h5, training_log.json
python stage2_dqn.py   # 輸出 dqn_player_weights.h5, training_log_stage2.json
python stage3_dqn.py   # 輸出 dqn_random_weights.h5, training_log_stage3.json
```
